...
Это бот с понятной инструкцией для покупки товаров с максимальным кэшбэком

Как это работает?
1 Выбирай товар из каталога

2 Открывай карточку и следуй шагам

3 Получай кэшбек и выгодные условия
...
🔥 Все товары в каталоге ждут тебя!""", reply_markup=keyboard)
